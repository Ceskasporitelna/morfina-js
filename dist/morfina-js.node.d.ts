...
declare module 'morfina-js/model' {
	import { AxiosRequestConfig } from 'axios'; type EncryptionType = 'AES' | 'PAILLIER';
...
declare module 'morfina-js/ApiClient' {
	import { Credentials, AxiosResponse, EncryptPayload, Config } from 'morfina-js/model';
	/**
	 *
	 * @class ApiClient
	 */
...
declare module 'morfina-js/Computer' {
	 class Computer {
	    private publicKey;
	    private privateKey;
	    /**
...
declare module 'morfina-js/Decryptor' {
	import { Credentials, EncryptPayload, EncryptionParameter, EncryptionType } from 'morfina-js/model'; class Decryptor {
	    private credentials;
	    private publicKey;
	    private privateKey;
	    /**
...
declare module 'morfina-js/utils' {
	 const isObjectEmpty: (obj: object) => boolean;
	export { isObjectEmpty };

}
declare module 'morfina-js/Client' {
